...
import NotificationBadge from "@/features/mypage/components/NotificationBadge"
...
const MYPAGE_ITEMS=[
    { id:1, title: "프로필", icon:<MyPageProfileIcon/>, section: "service", hasNewAlert: false  },
    { id:2, title: "알림 설정", icon:<MyPageNoticeIcon/>, section: "service", hasNewAlert: false},
    { id:3, title: "공지사항", icon:<MyPageNotificationIcon/>, section: "info", hasNewAlert: true},
    { id:4, title: "개인정보 처리방침", icon:<MyPagePrivacyIcon/>, section: "info", hasNewAlert: false},
    { id:5, title: "서비스 이용약관", icon:<MyPageTermsIcon/>, section: "info", hasNewAlert: false},
