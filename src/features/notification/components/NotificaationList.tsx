...
export default function NotificaationList({
  ...
  return (
    <div className="flex items-start gap-3 pt-3 cursor-pointer " onClick={onClick}>
        ...
        <div className="w-full flex flex-col gap-0.5 pb-3 border-b border-bluegray-light-hover">
