...
export default function Nav() {
    ...
    return (
        <div className="flex justify-around items-center w-full h-27 fixed bottom-0 bg-white border border-bluegray-light-hover">
            {NAV_ITEMS.map((item) => {
                ...
                return (
                    ...
                    className="flex flex-col items-center ">
                        ...
                        <p className={`text-xs ${isActive ? "text-bluegray-black" : "text-bluegray-normal"}`}>
                            {item.label}
                        </p>
                    </button>
                )
